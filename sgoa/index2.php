...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
    ...
    <body>
        <form action="aplicacion/validar.php" method="post">
            ...
            <h2 style = "color: #004e91; font-size: 80%; text-align=right"> ¿Olvidó su contraseña? </h2>        
        </form>
        <form method="post">
                <h2 style="color: #004e91; font-size: 250%;">Regístrate</h2>
                    ...
                    <label></label>
                    <td width="50%" text-align="right" valign="middle"><a href="aplicacion/formularios_registro/RegistrarEstudiante.php"> Registrar Estudiante</a></td>
                </form>
    </body>
</html>